...
export default function KeorPage() {
  const division = divisionsData.find((d) => d.slug === "keor")!;
  const programs = getProgramsByDivision("KEORGANISASIAN");
  const members = getMembersByDivision("KEORGANISASIAN");
  const [selectedMember, setSelectedMember] = useState<Member | null>(null);

  const pillarIcons = [Users, Award, HeartHandshake];

  return (
    <div className="flex min-h-screen flex-col bg-zinc-50 text-zinc-900 selection:bg-red-600 selection:text-white dark:bg-[#09090b] dark:text-zinc-100">
      <Navbar />
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b-2 border-black dark:border-zinc-800 bg-white dark:bg-zinc-950 py-16 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <nav className="mb-8 flex items-center gap-2 text-xs font-mono font-bold text-zinc-600 dark:text-zinc-400">
              ...
              <span>DIVISI</span>
              <ChevronRight className="h-3.5 w-3.5" />
              <span className="text-red-600 dark:text-red-400 font-black">KEORGANISASIAN</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                <div className="inline-flex items-center gap-2 rounded-lg border-2 border-black bg-red-600 px-3.5 py-1.5 text-xs font-mono font-black text-white shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <span className="ml-1 tracking-wider uppercase">{division.code} // ORGANIZATIONAL DEV</span>
                </div>

                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-zinc-900 dark:text-white leading-tight">
                  Divisi <span className="bg-red-600 text-white px-3 py-1 border-2 border-black shadow-[4px_4px_0px_0px_#000] inline-block -rotate-1">Keorganisasian</span>
                </h1>
                ...
                <div className="grid grid-cols-3 gap-4 pt-2 max-w-lg">
                  <div className="rounded-xl border-2 border-black bg-yellow-300 dark:bg-yellow-400 text-black p-4 shadow-[3px_3px_0px_0px_#000]">
                    <span className="block font-mono text-2xl sm:text-3xl font-black">{division.memberCount}</span>
                    <span className="font-mono text-xs font-bold uppercase">Pengurus Inti</span>
                  </div>
                  <div className="rounded-xl border-2 border-black bg-red-600 text-white p-4 shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <div className="rounded-xl border-2 border-black bg-emerald-500 text-white p-4 shadow-[3px_3px_0px_0px_#000]">
                    ...
                    <span className="font-mono text-xs font-bold uppercase">Kekeluargaan</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4">
                <div className="rounded-2xl border-4 border-black bg-white dark:bg-zinc-900 p-6 shadow-[6px_6px_0px_0px_#000] dark:shadow-[6px_6px_0px_0px_#3f3f46] space-y-4">
                  <div className="flex items-center justify-between pb-3 border-b-2 border-black dark:border-zinc-800">
                    <span className="font-mono text-xs font-black uppercase text-red-600 dark:text-red-400">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-mono font-bold text-red-600 dark:text-red-400">
                      Ketua Bidang Keorganisasian 2025/2026
                    </p>
                    <p className="text-xs text-zinc-600 dark:text-zinc-400 pt-2 font-medium italic">
                      &ldquo;Membangun ekosistem organisasi yang solid berlandaskan nilai kekeluargaan, integritas kepemimpinan, dan regenerasi kader yang berkelanjutan.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-24 bg-zinc-100 dark:bg-black border-b-2 border-black dark:border-zinc-800">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-2 rounded-lg border-2 border-black bg-red-600 px-3 py-1.5 text-xs font-mono font-black text-white shadow-[3px_3px_0px_0px_#000]">
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 dark:text-zinc-50">
                Tiga Pilar Keorganisasian
              </h2>
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                Pondasi pembentukan karakter, kepemimpinan berkarakter, dan kehangatan internal keluarga besar FOSTI.
              </p>
            </div>

            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              {division.pillars.map((pillar, idx) => {
                const Icon = pillarIcons[idx] || Users;
                return (
                  <div
                    key={pillar.title}
                  ...
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl border-2 border-black bg-red-600 text-white shadow-[3px_3px_0px_0px_#000] mb-5">
                      <Icon className="h-6 w-6" />
                    </div>
                    <span className="font-mono text-xs font-black text-red-600 dark:text-red-400 uppercase tracking-widest mb-1">
                      PILAR 0{idx + 1}
                    </span>
        ...
        <section className="py-20 lg:py-28 bg-white dark:bg-zinc-950 border-b-2 border-black dark:border-zinc-800">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                Rangkaian kegiatan pembinaan, kaderisasi, orientasi nilai, dan rapat evaluasi kepengurusan.
              </p>
            </div>
                ...
                >
                  <div className="relative h-48 w-full border-b-2 border-black dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-800">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="rounded-md border border-black bg-red-600 px-2.5 py-0.5 text-[11px] font-mono font-black text-white shadow-[2px_2px_0px_0px_#000]">
                        {program.category}
                      </span>
                    </div>
                  </div>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="max-w-2xl space-y-3">
                <div className="inline-flex items-center gap-2 rounded-lg border-2 border-black bg-red-600 px-3 py-1.5 text-xs font-mono font-black text-white shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <span className="uppercase">ORGANIZATIONAL CREW</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 dark:text-zinc-50">
                  Pengurus Divisi Keorganisasian
                </h2>
                <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                  Para penggerak roda organisasi yang senantiasa menjaga kehangatan, regenerasi, dan kedisiplinan keluarga FOSTI.
                </p>
              </div>
              ...
              <div className="text-xs font-mono font-bold text-zinc-500 dark:text-zinc-400 border-2 border-black dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3.5 py-2 rounded-lg shadow-[2px_2px_0px_0px_#000]">
                <span>Total: {members.length} Pengurus</span>
              </div>
            </div>
        ...
        <section className="py-16 bg-white dark:bg-zinc-950">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border-4 border-black bg-red-600 p-8 sm:p-12 shadow-[6px_6px_0px_0px_#000] text-white">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="space-y-2 text-center md:text-left">
                  ...
                  <p className="text-sm font-medium text-white/90">
                    Pelajari bagaimana divisi Riset & Teknologi dan Hubungan Publik bersinergi dengan Keorganisasian.
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link
                    href="/divisi/ristek"
                    className="inline-flex items-center gap-2 rounded-xl border-2 border-black bg-blue-600 px-5 py-3 text-sm font-black text-white shadow-[3px_3px_0px_0px_#000] hover:bg-blue-500 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_#000] transition-all"
                  >
                    <span>Divisi Riset & Teknologi</span>
                    <ArrowRight className="h-4 w-4" />
                  </Link>
                  <Link
                    href="/divisi/hubpub"
                    className="inline-flex items-center gap-2 rounded-xl border-2 border-black bg-yellow-400 px-5 py-3 text-sm font-black text-black shadow-[3px_3px_0px_0px_#000] hover:bg-yellow-300 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_#000] transition-all"
                  >
