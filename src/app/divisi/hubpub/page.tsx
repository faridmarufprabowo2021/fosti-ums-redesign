...
export default function HubpubPage() {
  const division = divisionsData.find((d) => d.slug === "hubpub")!;
  const programs = getProgramsByDivision("HUBUNGAN PUBLIK");
  const members = getMembersByDivision("HUBUNGAN PUBLIK");
  const [selectedMember, setSelectedMember] = useState<Member | null>(null);

  const pillarIcons = [Network, Megaphone, Radio];

  return (
    <div className="flex min-h-screen flex-col bg-zinc-50 text-zinc-900 selection:bg-yellow-400 selection:text-black dark:bg-[#09090b] dark:text-zinc-100">
      <Navbar />
        ...
        <section className="relative overflow-hidden border-b-2 border-black dark:border-zinc-800 bg-white dark:bg-zinc-950 py-16 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <nav className="mb-8 flex items-center gap-2 text-xs font-mono font-bold text-zinc-600 dark:text-zinc-400">
              ...
              <span>DIVISI</span>
              <ChevronRight className="h-3.5 w-3.5" />
              <span className="text-yellow-600 dark:text-yellow-400 font-black">HUBUNGAN PUBLIK</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-8 space-y-6">
                {/* Stud Header Badge */}
                <div className="inline-flex items-center gap-2 rounded-lg border-2 border-black bg-yellow-400 px-3.5 py-1.5 text-xs font-mono font-black text-black shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <span className="ml-1 tracking-wider uppercase">{division.code} // PUBLIC RELATIONS</span>
                </div>

                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-zinc-900 dark:text-white leading-tight">
                  Divisi <span className="bg-yellow-400 text-black px-3 py-1 border-2 border-black shadow-[4px_4px_0px_0px_#000] inline-block rotate-1">Hubungan Publik</span>
                </h1>

                <p className="text-lg sm:text-xl font-bold text-yellow-600 dark:text-yellow-400 font-mono">
                ...
                <div className="grid grid-cols-3 gap-4 pt-2 max-w-lg">
                  <div className="rounded-xl border-2 border-black bg-yellow-300 dark:bg-yellow-400 text-black p-4 shadow-[3px_3px_0px_0px_#000]">
                    ...
                    <span className="font-mono text-xs font-bold uppercase">Tim Media</span>
                  </div>
                  ...
                  <div className="rounded-xl border-2 border-black bg-emerald-500 text-white p-4 shadow-[3px_3px_0px_0px_#000]">
                    <span className="block font-mono text-2xl sm:text-3xl font-black">50+</span>
                    <span className="font-mono text-xs font-bold uppercase">Media Partner</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4">
                <div className="rounded-2xl border-4 border-black bg-white dark:bg-zinc-900 p-6 shadow-[6px_6px_0px_0px_#000] dark:shadow-[6px_6px_0px_0px_#3f3f46] space-y-4">
                  <div className="flex items-center justify-between pb-3 border-b-2 border-black dark:border-zinc-800">
                    <span className="font-mono text-xs font-black uppercase text-yellow-600 dark:text-yellow-400">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-mono font-bold text-yellow-600 dark:text-yellow-400">
                      Ketua Bidang Hubungan Publik 2025/2026
                    </p>
                    <p className="text-xs text-zinc-600 dark:text-zinc-400 pt-2 font-medium italic">
                      &ldquo;Menjadi garda terdepan dalam menyuarakan karya, memperluas kemitraan strategis, dan merajut relasi lintas komunitas teknologi secara bermakna.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 dark:text-zinc-50">
                Tiga Pilar Hubungan Publik
              </h2>
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                Pilar komunikasi, perluasan jejaring korporasi, serta publikasi digital yang berdaya jangkau luas.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              {division.pillars.map((pillar, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl border-2 border-black bg-yellow-400 text-black shadow-[3px_3px_0px_0px_#000] mb-5">
                      <Icon className="h-6 w-6" />
                    </div>
                    <span className="font-mono text-xs font-black text-yellow-600 dark:text-yellow-400 uppercase tracking-widest mb-1">
                      PILAR 0{idx + 1}
                    </span>
        ...
        <section className="py-20 lg:py-28 bg-white dark:bg-zinc-950 border-b-2 border-black dark:border-zinc-800">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl space-y-3">
              ...
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                Kunjungan industri, kemitraan media nasional, dan kampanye konten visual kreatif FOSTI UMS.
              </p>
            </div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5">
                          {program.highlights.map((item) => (
                            <div key={item} className="flex items-center gap-1.5 text-[11px] font-bold text-zinc-700 dark:text-zinc-300">
                              <CheckCircle2 className="h-3.5 w-3.5 text-yellow-600 flex-shrink-0" />
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="max-w-2xl space-y-3">
                <div className="inline-flex items-center gap-2 rounded-lg border-2 border-black bg-yellow-400 px-3 py-1.5 text-xs font-mono font-black text-black shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <span className="uppercase">PUBLIC RELATIONS CREW</span>
                </div>
                <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-zinc-900 dark:text-zinc-50">
                  Pengurus Divisi Hubungan Publik
                </h2>
                <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-medium">
                  Tim kreatif dan komunikasi yang aktif menggaungkan nama baik dan karya FOSTI UMS ke dunia luar.
                </p>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="space-y-2 text-center md:text-left">
                  ...
                  <p className="text-sm font-medium text-black/80">
                    Pelajari bagaimana divisi Riset & Teknologi dan Keorganisasian bersinergi dengan Hubungan Publik.
                  </p>
                </div>
